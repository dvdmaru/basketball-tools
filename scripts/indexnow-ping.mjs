 ...
 * basketball 的接點：update-basketball.py deploy 成功後收集本次變動 URL 呼叫本腳本。
 * KEY 依 IndexNow 協定為公開值（站根 <KEY>.txt 即驗證檔），非機密。
 */
const HOST = process.env.INDEXNOW_HOST ?? 'basketball.twtools.cc';
const KEY = process.env.INDEXNOW_KEY ?? '913ad6b1d90ac0a97e2bbe2c1e382ca3';
